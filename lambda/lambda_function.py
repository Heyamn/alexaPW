...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Aman's weather App."
...
class weatherIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = ''
        api_address = "http://api.openweathermap.org/data/2.5/weather?appid=91c4cce9b541296c4402ecca4767f6dd&units=metric&q="
        ...
        speak_output = "The weather is {}, {} and temp is {} of {} in {}. pw".format(formatted_json, description, temp, name, sys)
